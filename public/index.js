...
function handleEvent() {
  ...
  var api = "https://en.wikipedia.org/w/api.php?&origin=*&action=opensearch&search=".concat(searchTerm, "&limit=8");
  fetch(api).then(function (response) {
    ...
    var list = "<ul>".concat(data[1].map(function (item, index) {
      return "<li><a href=\"".concat(data[3][index], "\" target=\"_blank\">").concat(item, "</a><p>").concat(data[2][index], "</p></li>");
    }).join(""), "</ul>");
